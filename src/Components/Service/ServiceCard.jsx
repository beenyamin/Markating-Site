                              ...
                              <div className="text-center animate-slide-in ">
                                    ...
                                    <div>
                                          ...
                                          <p className="font-normal text-sm mt-2">
                                                ...
                                                Adjusts website layout <br /> for various screen sizes.</p>
                                    </div>
                              </div>
                        </div>
                        ...
                        <div className="flex items-center justify-center bg-white p-10 shadow-md border py-5 mx-auto rounded-md transition-all">
                              <div className="text-center animate-slide-in ">
                                    ...
                                    <div>
                                          ...
                                          <p className="font-normal text-sm mt-2">Original, innovative, and  <br /> different from the usual.<br />
                                          </p>
                                    </div>
                              </div>
                        </div>
                        ...
                        <div className="flex items-center justify-center bg-white p-10 shadow-md border py-5 mx-auto rounded-md transition-all">
                              <div className="text-center animate-slide-in ">
                                    ...
                                    <div>
                                          ...
                                          <p className="font-normal text-sm mt-2">
                                                Customer happy with product <br /> or service experience. <br /> </p>
                                    </div>
                              </div>
                        </div>
