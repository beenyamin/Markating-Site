          ...
          <nav
            ...
            <ul className="block md:flex md:gap-6 px-4 md:ml-24 ml-5">
              ...
              <div className='group relative md:px-2 md:pt-2 transition-all cursor-pointer'>
                ...
                {/* Dropdown */}
                <div className='absolute md:right-10 md:top-11 top-[220px] right-0  w-[250px] md:w-auto flex-col gap-1 hidden rounded-md text-black border-t-2 border-red-500 bg-white py-3 shadow-md transition-all group-hover:flex z-10'>
