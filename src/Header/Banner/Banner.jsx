...
const Banner = () => {
      ...
      return (
            <div style={bannerStyle} className="max-w-full lg:px-20 bg-gray-200">
              <Navbar/>
            <div className='flex flex-col lg:flex-row  items-center justify-between lg:pt-14 lg:pb-64 '>
              ...
              <div className='lg:w-[50%] w-full pl-5 '>
                ...
                <div className='py-4 space-y-2'>
                  ...
                  <p className='text-stone-600  '>We are 100+ professional software engineers with more than <br /> 10 years of experience in delivering superior products. Believe <br /> it because you've seen it. Here are real numbers</p>
                </div>
                ...
                <div className='pt-4 flex space-x-3 mt-4'>
                  ...
                  <div>
                    <h2 className=' text-base lg:text-base '>Joined Our Community
